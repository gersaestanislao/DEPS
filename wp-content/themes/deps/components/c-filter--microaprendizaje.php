    ...
    <div class="c-accordion__content c-catalogo__control-content js-accordion-content u-dblock@md" id="js-content-accordion-filter">
            ...
            <fieldset class="c-catalogo__content-filter" data-filter-group class="checkbox-group">
                ...
                <div class="checkbox c-catalogo__input-group">
                    ...
                    <img class="c-catalogo__icon" src="<?php bloginfo('template_url') ?>/src/img/icons/virus-solid.svg">
                ...
                <div class="checkbox c-catalogo__input-group">
                    ...
                    <img class="c-catalogo__icon" src="<?php bloginfo('template_url') ?>/src/img/icons/icono-covid.svg">
                ...
                <div class="checkbox c-catalogo__input-group">
                    ...
                    <img class="c-catalogo__icon" src="<?php bloginfo('template_url') ?>/src/img/icons/person-chalkboard-solid.svg">
                ...
                <div class="checkbox c-catalogo__input-group">
                    ...
                    <img class="c-catalogo__icon" src="<?php bloginfo('template_url') ?>/src/img/icons/heart-circle-exclamation-solid.svg">
                ...
                <div class="checkbox c-catalogo__input-group">
                    ...
                    <img class="c-catalogo__icon" src="<?php bloginfo('template_url') ?>/src/img/icons/head-side-virus-solid.svg">
                ...
                <div class="checkbox c-catalogo__input-group">
                    ...
                    <img class="c-catalogo__icon" src="<?php bloginfo('template_url') ?>/src/img/icons/bacteria-solid.svg">
                    <label class="checkbox-label c-catalogo__label o-text--paragraph">Virología</label>
                </div>


                <div class="checkbox c-catalogo__input-group">
                    <input class="c-catalogo__checkbox"  type="checkbox" value=".simulacion"/>
                    <img class="c-catalogo__icon" src="<?php bloginfo('template_url') ?>/src/img/icons/user-gear-solid.svg">
                    <label class="checkbox-label c-catalogo__label o-text--paragraph">Simulación Clínica</label>
                </div>
                ...
                <div class="checkbox c-catalogo__input-group">
                    <input class="c-catalogo__checkbox"  type="checkbox" value=".foro"/>
                    <img class="c-catalogo__icon" src="<?php bloginfo('template_url') ?>/src/img/icons/users-line-solid.svg">
                    <label class="checkbox-label c-catalogo__label o-text--paragraph">Foros de Educación</label>
                </div>

                  <div class="checkbox c-catalogo__input-group">
                    <input class="c-catalogo__checkbox"  type="checkbox" value=".antimicrobianos"/>
                    <img class="c-catalogo__icon" src="<?php bloginfo('template_url') ?>/src/img/icons/bacteria-solid.svg">
                    <label class="checkbox-label c-catalogo__label o-text--paragraph">Antimicrobianos</label>
                </div>

                <div class="checkbox c-catalogo__input-group">
                    <input class="c-catalogo__checkbox"  type="checkbox" value=".controldeinfecciones"/>
                    <img class="c-catalogo__icon" src="<?php bloginfo('template_url') ?>/src/img/icons/hand-holding-medical-solid.svg">
                    <label class="checkbox-label c-catalogo__label o-text--paragraph"> Prevención y Control de Infecciones</label>
                </div>

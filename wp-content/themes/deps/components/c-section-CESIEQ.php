        ...
        <div class="c-ead__wrapper">
            ...
            <div class="c-ead__col-text">
                <div class="c-ead__content-text">
                    <h3 class="c-ead__tittle"><?php the_field('title_CESIEQ'); ?></h3>
                    <div class="c-ead__content-descript">
                        <p><?php the_field('descript_CESIEQ'); ?></p>
                    </div>
                    <?php if( have_rows('btn_CESIEQ') ): ?>
                    <?php while( have_rows('btn_CESIEQ') ): the_row();
            ...
            <div class="c-ead__col-img">
                <img class="c-ead__img" src="<?php the_field('img_CESIEQ'); ?>">
            </div>

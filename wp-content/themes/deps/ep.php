            ...
            <div class="c-acd__col-tex">
             ...
             <div class="c-acd__col-img">
                <div class="c-acd__content-img">
                    <img class="c-acd__img" src="./src/img/nosotros.jpg" alt="">                    
                </div>
             </div> 
        ...
        <div class="c-mision__wrapper">
            ...
            <div class="c-mision__col-1">
                    ...
                    <div class="c-mision__col-img">
                        <img class="" src="./src/img/mision.png" alt="">                    
                    </div>
        ...
        <div class="c-vision__wrapper">
            ...
            <div class="c-vision__col-1">
                <div class="c-vision__content-descript">
                    ...
                    <p class="c-vision__descript">posicionando al IMSS al término del 2018 como líder nacional en la formación, actualización y capacitación del personal de salud a través del uso de recursos educativos apoyados en tecnologías de información y comunicación.</p>
            ...
            <div class="c-vision__col-2">
                <div class="c-vision__col-img">
                    <img class="" src="./src/img/vision.jpg" alt="">                    
                </div>
            </div>
            <!-- Col-2 -->
        </div>
